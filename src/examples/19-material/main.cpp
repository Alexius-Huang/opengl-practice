...
void _19_onScroll(GLFWwindow* window, double xOffset, double yOffset) {
    ...
    if (_19_ScrollEvent::fov < 1.0f) {
        _19_ScrollEvent::fov = 1.0f;
    } else if (_19_ScrollEvent::fov > 45.0f) {
        _19_ScrollEvent::fov = 45.0f;
    }
}
...
void _19_Material::setup() {
    ...
    // this->shaderProgram->setUniformF("uAmbientStrength", _19_Config::ambient);
    // this->shaderProgram->setUniformF("uSpecularStrength", _19_Config::specularStength);
    // this->shaderProgram->setUniformI("uSpecularPower", _19_Config::specularPower);
...
void _19_Material::render() {
    ...
    int index = ctx->gui->render(ctx->selectedExampleIndex, []() {
        ...
        // ImGui::SliderFloat("Ambient", &(_19_Config::ambient), 0.0f, 1.0f);
        // ImGui::SliderFloat("Specular Strength", &(_19_Config::specularStength), 0.0f, 1.0f);
        // ImGui::SliderInt("Specular Power", &(_19_Config::specularPower), 1, 128);
