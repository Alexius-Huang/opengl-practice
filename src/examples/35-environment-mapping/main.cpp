...
void _35_EnvironmentMapping::setup() {
    this->cube = new Cube;
    ...
    this->vertexShader = readShaderFile("./src/examples/35-environment-mapping/vertex-shader.vert");
    this->fragmentShader = readShaderFile("./src/examples/35-environment-mapping/fragment-shader.frag");
...
void _35_EnvironmentMapping::render() {
...
void _35_EnvironmentMapping::cleanup() {
    glDepthFunc(GL_LESS);
