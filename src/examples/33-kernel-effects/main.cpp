...
void _33_KernelEffects::setup() {
    ...
    this->vertexShader = readShaderFile("./src/examples/33-kernel-effects/vertex-shader.vert");
    this->fragmentShader = readShaderFile("./src/examples/33-kernel-effects/fragment-shader.frag");
    ...
    this->frameBufferVertexShader = readShaderFile("./src/examples/33-kernel-effects/frame-buffer-vertex-shader.vert");
    this->frameBufferFragmentShader = readShaderFile("./src/examples/33-kernel-effects/frame-buffer-fragment-shader.frag");
    ...
    this->frameBufferShaderProgram->setUniformF("uTexCoordOffset", this->uTexCoordOffset);
...
void _33_KernelEffects::cleanup() {
    MouseMoveEvent::dismiss(this->ctx->window);
