...
void _15_CameraLookAtMatrix::setup() {
    ...
    this->fragmentShader = readShaderFile("./src/examples/15-camera-look-at-matrix/fragment-shader.frag");
...
void _15_CameraLookAtMatrix::render() {
    ...
    glm::vec3 cameraDirection = glm::normalize(cameraPosition - this->cameraTarget);
...
void _15_CameraLookAtMatrix::cleanup() {
...
void _15_CameraLookAtMatrix::generateTransformationMatrix() {
