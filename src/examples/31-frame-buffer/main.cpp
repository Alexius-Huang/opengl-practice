...
void _31_FrameBuffer::setup() {
    ...
    this->vertexShader = readShaderFile("./src/examples/31-frame-buffer/vertex-shader.vert");
    this->fragmentShader = readShaderFile("./src/examples/31-frame-buffer/fragment-shader.frag");
    ...
    this->frameBufferVertexShader = readShaderFile("./src/examples/31-frame-buffer/frame-buffer-vertex-shader.vert");
    this->frameBufferFragmentShader = readShaderFile("./src/examples/31-frame-buffer/frame-buffer-fragment-shader.frag");
...
void _31_FrameBuffer::render() {
    ...
    // Bind to framebuffer first and draw scene as we normally would to color texture
    glBindFramebuffer(GL_FRAMEBUFFER, this->FBO);
    // glBindFramebuffer(GL_FRAMEBUFFER, 0);
    glEnable(GL_DEPTH_TEST);
